...
```bash
git clone https://github.com/ShieldElderAwaken/duckle-867.git
cd duckle-867
cargo build --release
cargo run
```
...
If you see something not listed, please [open an issue](https://github.com/ShieldElderAwaken/duckle-867/issues) with steps to reproduce + the relevant log line.
...
<!-- Last updated: 2026-06-06 20:21:05 -->
